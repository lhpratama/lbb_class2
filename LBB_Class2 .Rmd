...
```
Insight :
The **Naive Bayes** model has achieved an accuracy of 73.4%. It correctly predicted 187 dropouts and 480 graduates, while 146 individuals predicted to graduate ended up as dropouts, and 95 individuals predicted to be dropouts actually graduated.
...
```
Insight :
The train model has achieved an accuracy of 74.3%. It correctly predicted 747 dropouts and 871 graduates, while 341 individuals predicted to graduate ended up as dropouts, and 217 individuals predicted to be dropouts actually graduated.
...
```
Insight :
The  test model however, only  achieved an accuracy of 71.1%. It correctly predicted 204 dropouts and 133 graduates, while 129 individuals predicted to graduate ended up as dropouts, and 133 individuals predicted to be dropouts actually graduated.
...
```
Insight :
The  model created by using **Random Forest** has achieved an accuracy of 74.8%. It correctly predicted 237 dropouts and 443 graduates, while 96 individuals predicted to graduate ended up as dropouts, and 132 individuals predicted to be dropouts actually graduated.

# 5. SUMMARY

In the ranking of prediction models based on their accuracy, the **Random Forest** Model emerges as the top-performing model with an accuracy of **74.8%**. Following closely is the **Naive Bayes** Model with an accuracy of **73.4%**, and the **Decision Tree** Model exhibits a slightly lower accuracy of **71.1%**. This ranking suggests that the Random Forest Model has the highest predictive performance among the models considered, making it the preferred choice when accuracy is the primary evaluation criterion.


Ranking the prediction Model : 

The Random Forest Model accuracy : 74.8%
Naive Bayes Model : 73.4%
Decision Tree Model : 71.1%
